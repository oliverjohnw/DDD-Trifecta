...
from src.pages import matchups_and_spreads_page, standings_page, picks_and_scores_page, prizes_page, rules_page
...
pages = ["Matchups and Spreads", "Standings", "Picks and Scores", "Prizes", "Rules"]
